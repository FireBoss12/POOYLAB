...
public class p17_TrabajandoFlotantes {
    public static void main(String[] args) {
        ...
        System.out.println(String.format("num1, num2 en formato flotante                      : %f     -    %f",num1, num2));
        System.out.println(String.format("num1, num2 en formato flotante con decimales        : %.2f         -    %.3f",num1, num2));
        ...
        System.out.println(String.format("num4 con separador de miles y de decimales          : %,.2f", num4));
        ...
        System.out.println("\nUso de MIN_VALUE y MAX_VALUE para conocer los rangos de los números flotantes");
