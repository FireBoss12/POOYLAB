...
public class p16_TrabajandoEnteros {
    public static void main(String[] args) {
        ...
        System.out.println("num2 en base hexad            :" + Integer.toString(num2,16));
        System.out.println("num2 en base binaria          :" + Integer.toString(num2,2));
        System.out.println("num2 en base binaria          :" + Integer.toString(num3,2));
        ...
        System.out.printf("horas, dias en formato hexad           : %x  -  %x\n", horas, dias);
